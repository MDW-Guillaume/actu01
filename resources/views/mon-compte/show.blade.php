            ...
            <div class="user_info">
                ...
                <form action="{{ route('mon-compte') }}" method="post" class="user_personnal_info">
                    ...
                    <div class="user_personnal_info_text">
                        ...
                        <input name="name" type="text" id="user_personnal_info_name_input"
                            value="{{ $user_info->name }}" placeholder="{{ $user_info->name }}">
                    ...
                    <div class="user_personnal_info_text">
                        ...
                        <input name="email" type="email" id="user_personnal_info_email_input"
                            value="{{ $user_info->email }}" placeholder="{{ $user_info->email }}">
                        {{-- display : none jusqu'a interaction avec l'icone ou le bouton --}}
